<template>
    <div class="card">
        ...
        <p class="text-lg mb-4">
            Poseidon is an application template and is based on <a href="https://github.com/vuejs/create-vue" class="font-medium text-primary hover:underline">create-vue</a>, the recommended way to start a Vite-powered Vue projects. To get started,
            extract the contents of the zip file, cd to the directory and install the dependencies with npm, yarn or pnpm.
        </p>
        <pre class="app-code">
<code>npm install
npm run dev</code></pre>
        ...
        <p class="text-lg mb-4">Poseidon consists of a couple folders, demos and layout have been separated so that you can easily remove what is not necessary for your application such as the demos.</p>
        <ul class="leading-normal list-disc pl-8 text-lg mb-4">
            <li><span class="text-primary font-medium">src/layout</span>: Main layout structure.</li>
...
&#125;,</code></pre>
        ...
        <p class="text-lg mb-4">To learn more about how PrimeVue templates are implemented, visit the Sakai open source repository, Poseidon utilizes a similar structure as Sakai.</p>
