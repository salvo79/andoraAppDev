...
function saveProduct() {
    ...
    if (product?.value.name?.trim()) {
        if (product.value.id) {
            product.value.inventoryStatus = product.value.inventoryStatus.label ? product.value.inventoryStatus.label : product.value.inventoryStatus;
            ...
            product.value.inventoryStatus = product.value.inventoryStatus ? product.value.inventoryStatus.label : 'INSTOCK';
