...
const activeSection = ref('manufacturing-giants');
...
function getScrollContainer() {
    ...
    const contentWrapper = document.querySelector('.layout-content-wrapper');
    if (contentWrapper && contentWrapper.scrollHeight > contentWrapper.clientHeight) {
        scrollContainer.value = contentWrapper;
...
function handleScroll() {
    ...
    const threshold = 100; // Increased threshold for better section detection
    const oldActiveSection = activeSection.value;
    ...
    const sectionElements = sections.value
        ...
        .map((section) => ({
            ...section,
            top: getElementTop(section.element)
        }))
                ...
                <div class="flex flex-col gap-6 mb-8">
                    <div class="flex flex-col gap-2">
                        <div class="flex items-center gap-2">
                            <Tag value="INDUSTRIAL ECONOMICS" severity="secondary" class="font-normal! leading-normal!" />
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div class="w-px h-3 bg-surface-200 dark:bg-surface-700" />
                ...
                <div class="flex flex-col gap-16">
                    ...
                    <div id="workforce-development" class="flex flex-col gap-8">
                        <div class="flex flex-col gap-3">
                            ...
                            <p class="text-surface-500 dark:text-surface-300 text-lg leading-relaxed">
                                Manufacturing success depends not only on capital and technology but also on a skilled, adaptable workforce. Leading industrial companies invest heavily in workforce development programs, creating pathways for workers
                                to acquire advanced technical skills and adapt to evolving manufacturing technologies.
                            </p>
                        </div>
                        ...
                        <div class="flex items-start gap-4">
                            <div class="w-1 bg-primary-500 rounded-full self-stretch" />
                            <div class="flex-1">
                                <span class="text-surface-900 dark:text-surface-0 text-lg font-medium">Skills Gap Challenge:</span>
                                <span class="text-surface-500 dark:text-surface-300 text-lg">
                                    Research indicates that 80% of manufacturers report difficulty finding qualified workers with appropriate technical skills. Addressing this gap through strategic workforce development initiatives represents both a
                                    critical challenge and a significant opportunity for manufacturing growth and economic development.</span
                                >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-full pl-6 flex flex-col">
                        <div class="flex items-center gap-5 relative">
                            <div class="flex items-center justify-center w-8 h-8 rounded-full border border-surface-200 dark:border-surface-700 bg-white dark:bg-surface-900 relative z-10 shrink-0">
                                <i class="pi pi-list text-surface-900 dark:text-surface-0 text-xs" />
                            </div>
                            <div class="text-surface-500 dark:text-surface-400 text-base">On this page</div>
                        </div>

                        <div class="space-y-0 relative">
                            <div class="absolute left-4 top-[-20px] w-px bg-surface-200 dark:bg-surface-700" :style="{ height: `${sections.length * 44}px` }" />
                            ...
                            <div class="absolute left-4 w-2 h-2 rounded-full bg-surface-200 dark:bg-surface-700 -translate-x-[3px] z-10" :style="{ top: `${sections.length * 44 - 22}px` }" />
                            ...
                            <div
                                ...
                                :class="activeSection === section.id ? 'text-surface-900 dark:text-surface-0' : 'text-surface-500 dark:text-surface-400'"
                            >
