            ...
            <div class="relative mt-28 max-w-[36rem] mx-auto">
                ...
                >
                    ...
                    <div class="flex items-center gap-4">
                        <Button class="flex-1" rounded outlined>Cancel</Button>
                        <Button class="flex-1" rounded>Submit</Button>
                    </div>
                    <div class="flex items-center justify-center gap-2">
                        <span class="text-surface-500 dark:text-white/64">A problem? <a href="/landing/contact" class="text-primary">Click here</a> and let us help you.</span>
                    </div>
                </form>
            </div>
        </div>
